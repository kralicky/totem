...
const (
	Example_Stream_FullMethodName = "/simple.Example/Stream"
)
...
func (c *exampleClient) Stream(ctx context.Context, opts ...grpc.CallOption) (Example_StreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &Example_ServiceDesc.Streams[0], Example_Stream_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
var Example_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/kralicky/totem/examples/simple/example.proto",
}

const (
	Hello_Hello_FullMethodName = "/simple.Hello/Hello"
)
